...
<%@page import="com.flight.models.Reservation"%>
<%@page import="com.flight.models.Customer"%>
<%@page import="com.flight.models.Airport"%>
<%@page import="com.flight.dao.Customer_Dao"%>
<%@page import="com.flight.models.Fare"%>
<%@page import="com.flight.models.Flight"%>
...
<body>
	...
	Customer_Dao cust = new Customer_Dao();
